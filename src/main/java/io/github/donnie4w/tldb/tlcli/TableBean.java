...
public class TableBean implements org.apache.thrift.TBase<TableBean, TableBean._Fields>, java.io.Serializable, Cloneable, Comparable<TableBean> {
  ...
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.nio.ByteBuffer> columns; // optional
  public @org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.Byte> Idx; // optional
  ...
  public TableBean(TableBean other) {
    ...
    if (other.isSetColumns()) {
      java.util.Map<java.lang.String,java.nio.ByteBuffer> __this__columns = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>(other.columns);
      this.columns = __this__columns;
    }
    if (other.isSetIdx()) {
      java.util.Map<java.lang.String,java.lang.Byte> __this__Idx = new java.util.HashMap<java.lang.String,java.lang.Byte>(other.Idx);
  ...
  public TableBean setName(@org.apache.thrift.annotation.Nullable java.lang.String name) {
    this.name = name;
    return this;
  }
  ...
  public void putToColumns(java.lang.String key, java.nio.ByteBuffer val) {
    if (this.columns == null) {
      this.columns = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>();
    }
    this.columns.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,java.nio.ByteBuffer> getColumns() {
    return this.columns;
  }

  public TableBean setColumns(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.nio.ByteBuffer> columns) {
  ...
  public void putToIdx(java.lang.String key, byte val) {
    if (this.Idx == null) {
      this.Idx = new java.util.HashMap<java.lang.String,java.lang.Byte>();
    }
    this.Idx.put(key, val);
  }

  @org.apache.thrift.annotation.Nullable
  public java.util.Map<java.lang.String,java.lang.Byte> getIdx() {
    return this.Idx;
  }

  public TableBean setIdx(@org.apache.thrift.annotation.Nullable java.util.Map<java.lang.String,java.lang.Byte> Idx) {
    this.Idx = Idx;
    return this;
  }
  ...
  public void setFieldValue(_Fields field, @org.apache.thrift.annotation.Nullable java.lang.Object value) {
    ...
    case COLUMNS:
      if (value == null) {
        ...
        setColumns((java.util.Map<java.lang.String,java.nio.ByteBuffer>)value);
      }
      break;
    ...
    case IDX:
      if (value == null) {
        ...
        setIdx((java.util.Map<java.lang.String,java.lang.Byte>)value);
      }
      break;
  ...
  public int compareTo(TableBean other) {
    ...
    lastComparison = java.lang.Boolean.compare(isSetIdx(), other.isSetIdx());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetIdx()) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("TableBean(");
    boolean first = true;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.columns = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>(2*_map0.size);
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.Idx = new java.util.HashMap<java.lang.String,java.lang.Byte>(2*_map4.size);
      ...
      if (struct.columns != null) {
        if (struct.isSetColumns()) {
          oprot.writeFieldBegin(COLUMNS_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.nio.ByteBuffer> _iter8 : struct.columns.entrySet())
            {
      ...
      if (struct.Idx != null) {
        if (struct.isSetIdx()) {
          oprot.writeFieldBegin(IDX_FIELD_DESC);
          {
            ...
            for (java.util.Map.Entry<java.lang.String, java.lang.Byte> _iter9 : struct.Idx.entrySet())
            {
      ...
      if (struct.isSetColumns()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.nio.ByteBuffer> _iter10 : struct.columns.entrySet())
          {
      ...
      if (struct.isSetIdx()) {
        {
          ...
          for (java.util.Map.Entry<java.lang.String, java.lang.Byte> _iter11 : struct.Idx.entrySet())
          {
      ...
      if (incoming.get(1)) {
        {
          ...
          struct.columns = new java.util.HashMap<java.lang.String,java.nio.ByteBuffer>(2*_map12.size);
      ...
      if (incoming.get(2)) {
        {
          ...
          struct.Idx = new java.util.HashMap<java.lang.String,java.lang.Byte>(2*_map16.size);
